...
export function Hero({
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 -top-40 h-96 bg-[radial-gradient(60%_100%_at_50%_0%,rgb(254_229_0/0.16),transparent_70%)]"
      />
      ...
      <motion.div style={{ y, opacity }} className="relative z-10 mx-auto w-full max-w-7xl px-5 sm:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            >
              <Logo size={104} className="drop-shadow-[0_10px_40px_rgba(254,229,0,0.28)]" />
            </motion.div>
